...
class TestDrivenSecurityApplicationTests {
    ...
    void testConferenceInfo() {
        Assertions.assertThat(this.mockMvcTester.get()
                .uri("/about"))
                .hasStatus(HttpStatus.OK)
                .bodyText().contains("Join us online September 1–2!");
    }
    ...
    public void postAboutWithoutCsrfThenReturns403(){
        Assertions.assertThat(
                this.mockMvcTester.post()
                        .uri("/about")).hasStatus(HttpStatus.FORBIDDEN);
    }
